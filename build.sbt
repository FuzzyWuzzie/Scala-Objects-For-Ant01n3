...
libraryDependencies += "org.jogamp.gluegen" % "gluegen-rt" % "2.3.2" classifier "natives-macosx-universal" classifier ""

libraryDependencies += "org.jogamp.jogl" % "jogl-all" % "2.3.2" classifier "natives-macosx-universal" classifier ""
