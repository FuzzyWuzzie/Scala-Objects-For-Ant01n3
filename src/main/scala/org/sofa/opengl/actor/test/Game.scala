// package org.sofa.opengl.actor.test
...
// import org.sofa.opengl.actor.renderer.{Screen, Avatar, AvatarFactory, Renderer, RendererNewt, RendererActor, NoSuchScreenException, NoSuchAvatarException, Size, SizeTriplet, SizeFromTextureHeight, SizeFromTextureWidth, SizeFromScreenWidth, Acquaintance}
// import org.sofa.opengl.actor.renderer.screen.{MenuScreen, TileScreen}
// import org.sofa.opengl.actor.renderer.sprite.{ImageSprite, TilesSprite}
