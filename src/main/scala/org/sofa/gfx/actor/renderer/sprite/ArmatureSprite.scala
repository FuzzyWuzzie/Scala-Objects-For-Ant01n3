/*package org.sofa.gfx.avatar.renderer.sprite
...
import org.sofa.gfx.{Texture, ShaderProgram}
import org.sofa.gfx.mesh.{PlaneMesh, VertexAttribute}
import org.sofa.gfx.avatar.renderer.{Sprite, Screen, Avatar, AvatarIndex, AvatarState, AvatarIndex2D, NoSuchStateException}
import org.sofa.gfx.armature.{Armature}
import org.sofa.gfx.armature.behavior.{ArmatureBehavior, InParallelDynamic}
