...
//        gl = new backend.SGLJogl3(win.getGL.getGL3, GLU.createGLU)
        ...
        cubeShad = new ShaderProgram(gl, "gouraud shader",
                new VertexShader(gl, "gouraud", "src/main/scala/org/sofa/gfx/shaders/es2/pixelFlow3VertexShader.glsl"),
                new FragmentShader(gl, "gouraud", "src/main/scala/org/sofa/gfx/shaders/es2/pixelFlow3FragmentShader.glsl"))
//                new VertexShader(gl, "src-scala/org/sofa/gfx/shaders/pixelFlow3VertexShader.glsl"),
//                new FragmentShader(gl, "src-scala/org/sofa/gfx/shaders/pixelFlow3FragmentShader.glsl"))
        ...
        cube = new VertexArray(gl, cubeInd, ("vertices", p, 3, cubeVert), ("colors", c, 4, cubeClr), ("normals", n, 3, cubeNorm))
    }
