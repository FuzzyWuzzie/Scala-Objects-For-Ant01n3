...
import org.sofa.gfx.{SGL, MatrixStack, ShaderProgram, VertexArray, Camera, Shader}
import org.sofa.gfx.surface.{SurfaceRenderer, Surface, BasicCameraController}
import org.sofa.gfx.mesh.{PlaneMesh, PointsMesh, CubeMesh, AxisMesh, WireCubeMesh, TrianglesMesh, VertexAttribute}
...
class TestMetaBallsStereo extends SurfaceRenderer {
	...
	def test() {
		...
		surface        = new org.sofa.gfx.backend.SurfaceNewt(this,
							...
							org.sofa.gfx.backend.SurfaceNewtGLBackend.GL2ES2, 30, false, true)	
	}
