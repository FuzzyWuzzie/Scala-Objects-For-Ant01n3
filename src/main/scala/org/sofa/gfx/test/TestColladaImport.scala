...
import org.sofa.gfx.{VertexArray, ShaderProgram, Camera, Shader, MatrixStack}
import org.sofa.gfx.{SGL, HemisphereLight}
import org.sofa.gfx.mesh.{Mesh, PlaneMesh, EditableMesh, VertexAttribute}
