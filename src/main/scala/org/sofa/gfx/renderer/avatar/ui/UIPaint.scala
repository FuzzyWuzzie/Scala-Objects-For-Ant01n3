...
import org.sofa.gfx.renderer.{ Avatar, DefaultAvatar, DefaultAvatarComposed, DefaultAvatarMixed, AvatarName, AvatarRender, AvatarInteraction, AvatarSpace, AvatarContainer, AvatarFactory, DefaultAvatarFactory, AvatarSpaceState, AvatarState, AvatarBaseStates }
