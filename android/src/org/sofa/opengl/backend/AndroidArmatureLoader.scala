...
import org.sofa.opengl.simu.oberon.renderer.{Armature, ArmatureLoader, SVGArmatureLoader}
...
class AndroidArmatureLoader extends AndroidLoader with ArmatureLoader {
